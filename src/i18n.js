export default {
  cn: {
    ...
    legendWorldRemake: {
      downloadUrl: "https://file.marioforever.net/Mario%20Forever/%E5%9B%BD%E5%86%85%E4%BD%9C%E5%93%81/2025/LegendWorldRemake_v2.0.5.2.7z",
      downloadText: "下载"
    },
    legendWorldMW: {
    ...
    footer: {
      sections: [
        ...
        },
        {
          title: "友情链接",
          links: [
            { text: "Mario Forever 社区", href: "https://www.marioforever.net", target: "_blank" },
            { text: "百度永远的玛丽吧", href: "https://tieba.baidu.com/f?kw=%E6%B0%B8%E8%BF%9C%E7%9A%84%E7%8E%9B%E4%B8%BD", target: "_blank" },
            { text: "百度 Marioworker 吧", href: "https://tieba.baidu.com/f?kw=marioworker", target: "_blank" },
            { text: "Mario Forever 百科", href: "https://zh.wiki.marioforever.net/", target: "_blank" }
          ]
        },
        {
          title: "健康游戏忠告",
  ...
  en: {
    ...
    legendWorldRemake: {
      downloadUrl: "https://file.marioforever.net/mario-forever/games/chinese-fangames/2025/LegendWorldRemake_v2.0.5.2.7z",
