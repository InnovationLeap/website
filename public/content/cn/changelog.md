...
- 修复了 2-2 的扎地食人花图层错误
- 微调了 5-7 的一处悬浮桥位置
- 优化了 8-1 的一个与金砖重叠的隐藏绿蘑菇的顶出效果
- 修复了 8-! 最终 BOSS 部分可以翻越封顶的问题

#### v2.0.6 (2025-12-20)
- 修复了选择存档界面删除存档后，游戏进度百分比未立即隐藏的 Bug
- 修复了 5-2 密室出口的音乐标记位置不对，导致小个子出来时未切换回关卡主题 BGM 的问题
- 修复了 5-A 终点后面未封住，导致在高处触碰旗杆过关可能会摔死的问题
- 修复了 5-7 的隐藏绿蘑菇问号砖的颜色问题
- 修复了时间挑战中马里奥同时吃到两个相同颜色的时钟时，只算一次时间的 Bug
- 修复了 Legend Voyage-6 的库巴被甜菜击中时没有音效的 Bug
- 其他细微修复
